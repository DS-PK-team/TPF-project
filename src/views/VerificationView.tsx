...
export default function VerificationView() {
  ...
  // Support arriving from ProcessingView with a state flag
                    ...
                    {isReady ? (
                      ...
                      <div className="flex-1 min-w-0 pt-1">
                        ...
                        <div className="flex items-center gap-3">
                          {isWarning && (
                            <button className="font-body text-label-md text-tertiary hover:text-tertiary-container transition-colors flex items-center gap-1">
          ...
          <div className="bg-surface-container-lowest rounded-xl border border-outline-variant/30 shadow-[0px_4px_12px_rgba(0,0,0,0.03)] overflow-hidden flex-1 min-h-[500px] flex flex-col">
            ...
            <div className="bg-surface-container-low px-4 py-3 border-b border-outline-variant/30 flex items-center justify-between">
              <div className="flex items-center gap-sm">
                ...
                <span className="font-body text-label-md text-on-surface truncate max-w-[200px]">
                  Q3_Financial_Report_Final_v2.pdf
                </span>
              </div>
              <div className="flex gap-1.5">
                <span className="px-2 py-0.5 rounded-full bg-primary/10 text-primary text-[10px] font-bold uppercase tracking-wider">#Q3_2023</span>
                <span className="px-2 py-0.5 rounded-full bg-primary/10 text-primary text-[10px] font-bold uppercase tracking-wider">#Finance</span>
              </div>
            </div>
            {/* Skeleton preview */}
            <div className="flex-1 bg-surface-container p-6 flex items-center justify-center">
              <div className="w-full max-w-md aspect-[1/1.4] bg-surface-container-lowest shadow-md border border-outline-variant/20 rounded relative overflow-hidden flex flex-col p-8">
                ...
                <div className="absolute bottom-4 right-4 flex gap-2">
                  <button className="w-8 h-8 rounded-full bg-surface-container-low flex items-center justify-center text-on-surface hover:bg-surface-variant transition-colors border border-outline-variant/20">
